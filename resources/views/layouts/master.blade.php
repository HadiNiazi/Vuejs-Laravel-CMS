  ...
  <div class="layout-wrapper layout-2" id="app">
    <div class="layout-inner">
      ...
      <div id="layout-sidenav" class="layout-sidenav sidenav sidenav-vertical bg-dark">
        ...
        <ul class="sidenav-inner py-1">
          ...
          <li class="sidenav-item">
            <router-link to="/admin/dashboard" class="sidenav-link"><i class="sidenav-icon ion ion-md-speedometer"></i>
              <div>Dashboard</div>
            </router-link>
          ...
          <li class="sidenav-item">
            ...
            <li class="sidenav-item">
                <router-link to="/admin/users" class="sidenav-link"><i class="sidenav-icon fas fa-users"></i>
                    <div>Users</div>
                </router-link>
            </li>
        ...
        <nav class="layout-navbar navbar navbar-expand-lg align-items-lg-center bg-white container-p-x" id="layout-navbar">
          ...
          <div class="navbar-collapse collapse" id="layout-navbar-collapse">
            ...
            <div class="navbar-nav align-items-lg-center">
              <!-- Search -->
              <label class="nav-item navbar-text navbar-search-box p-0">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <div class="list-group list-group-flush">
                    <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                        ...
                        <img src="{{ asset('img/avatars/6-small.png') }}" class="d-block ui-w-40 rounded-circle" alt>
                    ...
                    <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                      <img src=" {{ asset('img/avatars/4-small.png') }}" class="d-block ui-w-40 rounded-circle" alt>
                      <div class="media-body ml-3">
                    ...
                    <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                      <img src=" {{ asset('img/avatars/5-small.png') }}" class="d-block ui-w-40 rounded-circle" alt>
                      <div class="media-body ml-3">
                        <div class="text-body line-height-condenced">Sit meis deleniti eu, pri vidit meliore docendi ut.</div>
                        <div class="text-light small mt-1">
                    ...
                    <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                      <img src=" {{ asset('img/avatars/11-small.png') }}" class="d-block ui-w-40 rounded-circle" alt>
                      <div class="media-body ml-3">
              ...
              <div class="demo-navbar-user nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                  <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                    <img src=" {{ asset('img/avatars/1.png') }}" alt class="d-block ui-w-30 rounded-circle">
     ...
     <div class="layout-content">
         ...
         <!-- Start Layout Content from here -->
