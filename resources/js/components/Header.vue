            ...
            <div class="navbar-nav align-items-lg-center">
              ...
              <label class="nav-item navbar-text navbar-search-box p-0 active">
                ...
                <span class="navbar-search-input pl-2">
                  <input type="text" class="form-control navbar-text mx-2" v-model="search" @keyup.enter="searching" placeholder="Search..." style="width:200px">
                </span>
              </label>
            </div>
...
export default {
    ...
    methods:{
        searching: debounce(function(){
            ...
            EventBus.$emit('searchedString', this.search);
        }, 1000)
    }
}
</script>
