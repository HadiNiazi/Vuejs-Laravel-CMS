                ...
                <div class="col-md-8 col-lg-12 col-xl-8">
                  <div class="card-body">
                    <div style="height: 210px;">
                      <canvas id="statistics-chart-1" style="display: block; height: 210px; width: 705px;" width="1057" height="315"></canvas>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-4">
                  ...
                  <div class="mt-3">
                    <div style="height:100px;">
                      <canvas id="statistics-chart-2" width="541" height="150" style="display: block; height: 100px; width: 361px;"></canvas>
                    </div>
                  </div>
                ...
                <div class="card mb-4">
                  ...
                  <div class="px-2">
                    <div class="w-100" style="height: 117px;">
                      <canvas id="statistics-chart-3" width="517" height="175" style="display: block; height: 117px; width: 345px;"></canvas>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-4">
                  <div class="card-body pb-0">
                    ...
                    <div class="my-3" style="height: 86px;">
                      <canvas id="statistics-chart-4" width="469" height="129" style="display: block; height: 86px; width: 313px;"></canvas>
                    </div>
                  </div>
                  ...
                  <div class="bg-success text-white">
                    <div class="d-flex align-items-center position-relative mt-4" style="height:140px;">
                      <div class="w-100 position-absolute" style="height:140px;top:0;">
                        <canvas id="statistics-chart-5" width="397" height="210" style="display: block; height: 140px; width: 265px;"></canvas>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 234px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 150px;"></div></div></div>
                      <div class="card-footer">
                ...
                <div class="card mb-4">
                  ...
                  <div class="py-4 px-3">
                    <div style="height:162px;">
                      <canvas id="statistics-chart-6" width="493" height="243" style="display: block; height: 162px; width: 329px;"></canvas>
                    </div>
                  </div>
                </div>
                <!-- / Type gadgets chart -->
